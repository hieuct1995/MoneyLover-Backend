...
const GOOGLE_MAILER_REFRESH_TOKEN =
    ...
    '1//04bWQtAqciXmKCgYIARAAGAQSNwF-L9IrZ6JoUZIPtGZaiE6meD9Em1Dk0oHyF_ZS21RbblKcGuxuoobWLoMA8m7hUzgZiKNES9c';
    ...
    static async createUser(req: Request, res: Response) {
        try {
            ...
            if (!user) {
                ...
                if (result) {
                    let content = `<h3>Please <a href="https://money-lover-demo-liart.vercel.app/verify/${verifyEmailToken}">click here</a> to verify your email</h3>`
